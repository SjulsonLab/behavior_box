...
session_info['InterTrialInterval']        = []      # inter-trial interval in s to be mixed with a exponential distribution in arduino
...
session_info['rewardCollectionLength'] = 100
...
try:
    ...
    while exit_loop == False:
        ...
        session_info['InterTrialInterval'].append(ITIduration)
        ...
        #check the trial number and evaluate if we change the ITI or not
        if changeITI == 20:
            ITIduration = random.choice(ITIoptions)
            changeITI = 0
